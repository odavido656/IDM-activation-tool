...
echo:                                                          
echo:          [1] 慾魂 IDM                                
echo:          [2] 婓registry笢笭离 IDM 慾魂/?蚚
echo:          _____________________________________________   
echo:                                                          
call :_color2 %_White% "          [3] 遙 Windows Defender  " %_col% "[%_status%]"
echo:          _____________________________________________   
echo:                                                          
echo:          [4] 挲隴                                  
echo:          [5] 豖堤                                     
echo:       ___________________________________________________
echo:   
call :_color2 %_White% "        " %_Green% "婓瑩攫 [1,2,3,4,5] 笢?粕腢?"
choice /C:12345 /N
set _erl=%errorlevel%
...
call :_color %Green% "IDM 慾魂 - 婓蛁聊桶笢傖髡笭离"
) else (
call :_color %Red% "楊俇笭离 IDM 慾魂 - ?蚚"
)
...
if not exist "!IDMan!" (
call :_color %Red% "帤假蚾 IDM [Internet Download Manager] "
echo 蠟褫眕  https://www.internetdownloadmanager.com/download.html  狟徭
goto done
)
...
if not [%errorlevel%]==[0] (
call :_color %Red% "楊窣諉 internetdownloadmanager.comㄛ淏婓笢砦..."
goto done
)
...
echo %line%
echo:
call :_color %Green% "IDM 眒傖髡慾魂"
echo:
call :_color %Gray% "彆寂唳枑尨堤政ㄛ婬棒綅俴慾魂腢?ㄛ眳摽坳憩祥堤政賸"
goto done
)
